...
@NoArgsConstructor
@SuperBuilder
public class SectionWithAccountLesson extends BaseEntityDto implements Serializable {
    private UUID id;
    private String title;
    private Integer orderNumber;
    private UUID courseId;
    // Add account lessons list to include lessons inside section in responses
    private List<AccountLessonDto> accountLessons;
